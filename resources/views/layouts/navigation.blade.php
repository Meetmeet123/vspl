        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('combo-plans.index')" :active="request()->routeIs('combo-plans.index')">
                        {{ __('Combo Plans') }}
                    </x-nav-link>
                    <x-nav-link :href="route('eligibility-criteria.index')" :active="request()->routeIs('eligibility-criteria.index')">
