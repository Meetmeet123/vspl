        ...
        <form action="{{ isset($eligibilityCriteria) ? route('eligibility-criteria.update', $eligibilityCriteria->id) : route('eligibility-criteria.store') }}" method="POST" id="eligibilityForm">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" id="last_login" name="last_login" class="form-control" value="{{ old('last_login_days_ago', $eligibilityCriteria->last_login_days_ago->format('Y-m-d\TH:i') ?? '') }}">
                </div>
